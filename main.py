...
while True:
    ...
    print(
        "4-Crear una clase `Lapiz` que tenga los atributos `color` (cadena de caracteres) y `grosor` (entero). El constructor debe inicializar ambos atributos con valores por defecto. Agregar un método `escribir` que imprima por pantalla la frase Escribiendo con un lapiz de [color] y grosor [grosor]. Crear un objeto de la clase `Lapiz` e invocar el método `escribir`.")
    ...
    print("14-Colecciones Luis y Ana")
